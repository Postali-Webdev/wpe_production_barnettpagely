...
<head>
	...
	if ( is_page() && !is_page_template() ) {
		...
		if( $title_image ) {	
			echo '<link rel="preload" as="image" href="' . checkWebpCompatibility($title_image) . '" />';	
		}
	}
	?>
...
<header class="animate <?php if(isset($qode_options_passage['header_fixed']) && $qode_options_passage['header_fixed'] == "no"){ echo "no_fixed"; } ?><?php if($centered_logo){ echo " centered_logo"; } ?>">
	...
	<?php } ?>
				<div class="header_inner clearfix">
					<div class="logo"><a href="<?php echo home_url(); ?>/" title="Law Offices of Ned Barnett"><img src="<?php echo $qode_options_passage['logo_image']; ?>" alt="Logo"/></a>            
                    <div class="header_phone_widget"> <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Header-Phone') ) : ?><?php endif; ?></div>                  
                    </div>
