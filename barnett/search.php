	...
	<div class="container top_move <?php if($content_animation == 'no'){ echo 'no_entering_animation'; }  ?>">
		<div class="container_inner clearfix">
			...
			<div class="slider_search">
				<form role = "search" method="get" id = "searchform" action="https://www.nedbarnett.com/">
					<div>
						<label class="screen-reader-text" for ="s"></label>
						<label class = "fade">
						<input type="text" class = "dynamic-placeholder placeholder" name="s" id = "s" autocomplete="off" placeholder="Not what you were looking for? Try your search again"></input>
						</label>
